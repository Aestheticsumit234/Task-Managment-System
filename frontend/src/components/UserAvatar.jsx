          ...
          <Menu.Items className="absolute  right-0 mt-2 w-52 origin-top-right divide-gray-100 rounded-md bg-white shadow-2xl ring-1 ring-black/5 focus:outline-none">
            <div className="p-4">
              <Menu.Item className="border-t border-gray-100 cursor-pointer">
                {({ active }) => (
                  <button
                    className="text-green-700 group flex w-full items-center text-center rounded-md px-2 py-2 text-base"
              ...
              <Menu.Item className="border-t border-gray-100 cursor-pointer">
                {({ active }) => (
                  <button
                    className="text-yellow-500 group flex w-full items-center text-center rounded-md px-2 py-2 text-base"
              ...
              <Menu.Item className="border-t border-gray-100 cursor-pointer">
                {({ active }) => (
                  <button
                    className="group flex w-full items-center text-center text-red-700 rounded-md px-2 py-2 text-base"
