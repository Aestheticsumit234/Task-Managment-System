    ...
    <>
      <Popover className="relative">
        <Popover.Button className="inline-flex items-center outline-none">
          <div className="w-7 h-7 flex items-center justify-center cursor-pointer  text-gray-800 relative">
            <IoIosNotificationsOutline className="text-3xl " />
            {data?.length > 0 && (
              <span className="absolute flex items-center justify-center text-center top-0 right-0 text-xs text-white font-semibold w-4 h-4 rounded-full bg-red-600">
                {data?.length}
              </span>
            )}
          </div>
